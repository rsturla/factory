...
import (
	v1 "gitlab.com/redhat/hummingbird/experimental/factory/core/gen/openshell/datamodel/v1"
	v11 "gitlab.com/redhat/hummingbird/experimental/factory/core/gen/openshell/sandbox/v1"
...
const file_openshell_proto_rawDesc = "" +
	...
	"\fsandbox_name\x18\x01 \x01(\tR\vsandboxName\"f\n" +
	"\x1cAttachSandboxProviderRequest\x12!\n" +
	"\fsandbox_name\x18\x01 \x01(\tR\vsandboxName\x12#\n" +
	"\rprovider_name\x18\x02 \x01(\tR\fproviderName\"f\n" +
	...
	"\x18SERVICE_STATUS_UNHEALTHY\x10\x032\xf1#\n" +
	"\tOpenShell\x12C\n" +
	...
	"\x0fGetDraftHistory\x12$.openshell.v1.GetDraftHistoryRequest\x1a%.openshell.v1.GetDraftHistoryResponseBJZHgitlab.com/redhat/hummingbird/experimental/factory/core/gen/openshell/v1b\x06proto3"
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 140)
var file_openshell_proto_goTypes = []any{
	...
	(*SshSession)(nil),                            // 44: openshell.v1.SshSession
	...
	(*SandboxStreamWarning)(nil),                  // 48: openshell.v1.SandboxStreamWarning
	(*CreateProviderRequest)(nil),                 // 49: openshell.v1.CreateProviderRequest
	(*GetProviderRequest)(nil),                    // 50: openshell.v1.GetProviderRequest
	(*ListProvidersRequest)(nil),                  // 51: openshell.v1.ListProvidersRequest
	(*UpdateProviderRequest)(nil),                 // 52: openshell.v1.UpdateProviderRequest
	(*DeleteProviderRequest)(nil),                 // 53: openshell.v1.DeleteProviderRequest
	(*ProviderResponse)(nil),                      // 54: openshell.v1.ProviderResponse
	(*ListProvidersResponse)(nil),                 // 55: openshell.v1.ListProvidersResponse
	(*ListProviderProfilesRequest)(nil),           // 56: openshell.v1.ListProviderProfilesRequest
	(*GetProviderProfileRequest)(nil),             // 57: openshell.v1.GetProviderProfileRequest
	(*ProviderProfileImportItem)(nil),             // 58: openshell.v1.ProviderProfileImportItem
	(*ProviderProfileDiagnostic)(nil),             // 59: openshell.v1.ProviderProfileDiagnostic
	(*ProviderProfileCredential)(nil),             // 60: openshell.v1.ProviderProfileCredential
	(*ProviderProfile)(nil),                       // 61: openshell.v1.ProviderProfile
	(*StoredProviderProfile)(nil),                 // 62: openshell.v1.StoredProviderProfile
	(*ProviderProfileResponse)(nil),               // 63: openshell.v1.ProviderProfileResponse
	(*ListProviderProfilesResponse)(nil),          // 64: openshell.v1.ListProviderProfilesResponse
	(*ImportProviderProfilesRequest)(nil),         // 65: openshell.v1.ImportProviderProfilesRequest
	(*ImportProviderProfilesResponse)(nil),        // 66: openshell.v1.ImportProviderProfilesResponse
	(*LintProviderProfilesRequest)(nil),           // 67: openshell.v1.LintProviderProfilesRequest
	(*LintProviderProfilesResponse)(nil),          // 68: openshell.v1.LintProviderProfilesResponse
	(*DeleteProviderResponse)(nil),                // 69: openshell.v1.DeleteProviderResponse
	(*DeleteProviderProfileRequest)(nil),          // 70: openshell.v1.DeleteProviderProfileRequest
	(*DeleteProviderProfileResponse)(nil),         // 71: openshell.v1.DeleteProviderProfileResponse
	(*GetSandboxProviderEnvironmentRequest)(nil),  // 72: openshell.v1.GetSandboxProviderEnvironmentRequest
	(*GetSandboxProviderEnvironmentResponse)(nil), // 73: openshell.v1.GetSandboxProviderEnvironmentResponse
	(*UpdateConfigRequest)(nil),                   // 74: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                  // 75: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                        // 76: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                 // 77: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                     // 78: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                          // 79: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                         // 80: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                   // 81: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                  // 82: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),         // 83: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),        // 84: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),            // 85: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),           // 86: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),             // 87: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),            // 88: openshell.v1.ReportPolicyStatusResponse
	(*SandboxPolicyRevision)(nil),                 // 89: openshell.v1.SandboxPolicyRevision
	(*GetSandboxLogsRequest)(nil),                 // 90: openshell.v1.GetSandboxLogsRequest
	(*PushSandboxLogsRequest)(nil),                // 91: openshell.v1.PushSandboxLogsRequest
	(*PushSandboxLogsResponse)(nil),               // 92: openshell.v1.PushSandboxLogsResponse
	(*GetSandboxLogsResponse)(nil),                // 93: openshell.v1.GetSandboxLogsResponse
	(*SupervisorMessage)(nil),                     // 94: openshell.v1.SupervisorMessage
	(*GatewayMessage)(nil),                        // 95: openshell.v1.GatewayMessage
	(*SupervisorHello)(nil),                       // 96: openshell.v1.SupervisorHello
	(*SessionAccepted)(nil),                       // 97: openshell.v1.SessionAccepted
	(*SessionRejected)(nil),                       // 98: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                   // 99: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                      // 100: openshell.v1.GatewayHeartbeat
	(*RelayOpen)(nil),                             // 101: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                        // 102: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                        // 103: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                             // 104: openshell.v1.RelayInit
	(*RelayFrame)(nil),                            // 105: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                       // 106: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                            // 107: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                       // 108: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                         // 109: openshell.v1.DenialSummary
	(*PolicyChunk)(nil),                           // 110: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                     // 111: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),           // 112: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),          // 113: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                 // 114: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                // 115: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),              // 116: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),             // 117: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),               // 118: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),              // 119: openshell.v1.RejectDraftChunkResponse
	(*ApproveAllDraftChunksRequest)(nil),          // 120: openshell.v1.ApproveAllDraftChunksRequest
	(*ApproveAllDraftChunksResponse)(nil),         // 121: openshell.v1.ApproveAllDraftChunksResponse
	(*EditDraftChunkRequest)(nil),                 // 122: openshell.v1.EditDraftChunkRequest
	(*EditDraftChunkResponse)(nil),                // 123: openshell.v1.EditDraftChunkResponse
	(*UndoDraftChunkRequest)(nil),                 // 124: openshell.v1.UndoDraftChunkRequest
	(*UndoDraftChunkResponse)(nil),                // 125: openshell.v1.UndoDraftChunkResponse
	(*ClearDraftChunksRequest)(nil),               // 126: openshell.v1.ClearDraftChunksRequest
	(*ClearDraftChunksResponse)(nil),              // 127: openshell.v1.ClearDraftChunksResponse
	(*GetDraftHistoryRequest)(nil),                // 128: openshell.v1.GetDraftHistoryRequest
	(*DraftHistoryEntry)(nil),                     // 129: openshell.v1.DraftHistoryEntry
	(*GetDraftHistoryResponse)(nil),               // 130: openshell.v1.GetDraftHistoryResponse
	(*PolicyRevisionPayload)(nil),                 // 131: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                     // 132: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                  // 133: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                      // 134: openshell.v1.StoredDraftChunk
	nil,                                           // 135: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                           // 136: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                           // 137: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                           // 138: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                           // 139: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                           // 140: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                           // 141: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                           // 142: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                           // 143: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	(*v1.ObjectMeta)(nil),                         // 144: openshell.datamodel.v1.ObjectMeta
	(*v11.SandboxPolicy)(nil),                     // 145: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                       // 146: google.protobuf.Struct
	(*v1.Provider)(nil),                           // 147: openshell.datamodel.v1.Provider
	(*v11.NetworkEndpoint)(nil),                   // 148: openshell.sandbox.v1.NetworkEndpoint
	(*v11.NetworkBinary)(nil),                     // 149: openshell.sandbox.v1.NetworkBinary
	(*v11.SettingValue)(nil),                      // 150: openshell.sandbox.v1.SettingValue
	(*v11.NetworkPolicyRule)(nil),                 // 151: openshell.sandbox.v1.NetworkPolicyRule
	(*v11.L7DenyRule)(nil),                        // 152: openshell.sandbox.v1.L7DenyRule
	(*v11.L7Rule)(nil),                            // 153: openshell.sandbox.v1.L7Rule
	(*v11.GetSandboxConfigRequest)(nil),           // 154: openshell.sandbox.v1.GetSandboxConfigRequest
	(*v11.GetGatewayConfigRequest)(nil),           // 155: openshell.sandbox.v1.GetGatewayConfigRequest
	(*v11.GetSandboxConfigResponse)(nil),          // 156: openshell.sandbox.v1.GetSandboxConfigResponse
	(*v11.GetGatewayConfigResponse)(nil),          // 157: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	3,   // 0: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	144, // 1: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	135, // 5: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	8,   // 6: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	145, // 7: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	136, // 8: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	137, // 9: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	138, // 10: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	146, // 11: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	146, // 12: openshell.v1.SandboxTemplate.volume_claim_templates:type_name -> google.protobuf.Struct
	10,  // 13: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	139, // 14: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	7,   // 15: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	140, // 16: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	...
	147, // 19: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	...
	144, // 23: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	33,  // 24: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	141, // 25: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	...
	102, // 29: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	103, // 30: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	42,  // 31: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	144, // 32: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	6,   // 33: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	47,  // 34: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	11,  // 35: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	48,  // 36: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	111, // 37: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	142, // 38: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	147, // 39: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	147, // 40: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	147, // 41: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	147, // 42: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	61,  // 43: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	1,   // 44: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	60,  // 45: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	148, // 46: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	149, // 47: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	144, // 48: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	61,  // 49: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	61,  // 50: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	61,  // 51: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	58,  // 52: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	59,  // 53: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	61,  // 54: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	58,  // 55: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	59,  // 56: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	143, // 57: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	145, // 58: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	150, // 59: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	75,  // 60: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	76,  // 61: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	77,  // 62: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	78,  // 63: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	79,  // 64: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	80,  // 65: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	81,  // 66: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	151, // 67: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	152, // 68: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	153, // 69: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	89,  // 70: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	89,  // 71: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	2,   // 72: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	2,   // 73: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	145, // 74: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	47,  // 75: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	47,  // 76: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	96,  // 77: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	99,  // 78: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	106, // 79: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	107, // 80: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	97,  // 81: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	98,  // 82: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	100, // 83: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	101, // 84: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	107, // 85: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	102, // 86: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	103, // 87: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	104, // 88: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	108, // 89: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	151, // 90: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	109, // 91: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	110, // 92: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	110, // 93: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	151, // 94: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	129, // 95: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	145, // 96: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	151, // 97: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	4,   // 98: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	12,  // 99: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	13,  // 100: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	14,  // 101: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	15,  // 102: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	16,  // 103: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	17,  // 104: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	18,  // 105: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	25,  // 106: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	27,  // 107: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	28,  // 108: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	29,  // 109: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	31,  // 110: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	35,  // 111: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	37,  // 112: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	43,  // 113: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	49,  // 114: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	50,  // 115: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	51,  // 116: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	56,  // 117: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	57,  // 118: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	65,  // 119: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	67,  // 120: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	52,  // 121: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	53,  // 122: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	70,  // 123: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	154, // 124: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	155, // 125: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	74,  // 126: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	83,  // 127: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	85,  // 128: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	87,  // 129: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	72,  // 130: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	90,  // 131: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	91,  // 132: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	94,  // 133: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	105, // 134: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	45,  // 135: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	112, // 136: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	114, // 137: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	116, // 138: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	118, // 139: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	120, // 140: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	122, // 141: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	124, // 142: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	126, // 143: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	128, // 144: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	5,   // 145: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	19,  // 146: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	19,  // 147: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	20,  // 148: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	21,  // 149: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	22,  // 150: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	23,  // 151: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	24,  // 152: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	26,  // 153: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	34,  // 154: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	34,  // 155: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	30,  // 156: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	32,  // 157: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	36,  // 158: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	41,  // 159: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	43,  // 160: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	54,  // 161: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	54,  // 162: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	55,  // 163: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	64,  // 164: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	63,  // 165: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	66,  // 166: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	68,  // 167: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	54,  // 168: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	69,  // 169: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	71,  // 170: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	156, // 171: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	157, // 172: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	82,  // 173: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	84,  // 174: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	86,  // 175: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	88,  // 176: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	73,  // 177: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	93,  // 178: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	92,  // 179: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	95,  // 180: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	105, // 181: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	46,  // 182: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	113, // 183: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	115, // 184: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	117, // 185: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	119, // 186: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	121, // 187: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	123, // 188: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	125, // 189: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	127, // 190: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	130, // 191: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
