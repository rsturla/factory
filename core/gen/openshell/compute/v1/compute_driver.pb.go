...
type GetCapabilitiesResponse struct {
	...
	// Optional feature flags advertised by the driver. Keys are stable strings
	// registered in the compute-driver capability registry. Unknown keys are
	// ignored by the gateway. Missing or empty map means no optional features.
...
func (x *GetCapabilitiesResponse) GetFeatures() map[string]bool {
	if x != nil {
		return x.Features
	}
	return nil
...
func (x *DriverCondition) GetLastTransitionTime() *timestamppb.Timestamp {
	if x != nil {
...
type ListSandboxesRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Maximum number of sandboxes to return. When zero the driver chooses a
	// reasonable default.
	PageSize int32 `protobuf:"varint,1,opt,name=page_size,json=pageSize,proto3" json:"page_size,omitempty"`
	// Opaque token returned by a previous ListSandboxesResponse. Pass it
...
const file_compute_driver_proto_rawDesc = "" +
	"\n" +
	"\x14compute_driver.proto\x12\x14openshell.compute.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x18\n" +
	...
	"\tgpu_count\x18\x05 \x01(\rR\bgpuCount\x12W\n" +
	"\bfeatures\x18\x06 \x03(\v2;.openshell.compute.v1.GetCapabilitiesResponse.FeaturesEntryR\bfeatures\x1a;\n" +
	...
	"conditions\x12\x1a\n" +
	"\bdeleting\x18\x06 \x01(\bR\bdeleting\"\xbd\x01\n" +
	"\x0fDriverCondition\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\x12\x18\n" +
	"\amessage\x18\x04 \x01(\tR\amessage\x12L\n" +
	"\x14last_transition_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\x12lastTransitionTime\"\xa8\x02\n" +
	...
	"\asandbox\x18\x01 \x01(\v2#.openshell.compute.v1.DriverSandboxR\asandbox\"R\n" +
	"\x14ListSandboxesRequest\x12\x1b\n" +
	"\tpage_size\x18\x01 \x01(\x05R\bpageSize\x12\x1d\n" +
	"\n" +
	"page_token\x18\x02 \x01(\tR\tpageToken\"\x82\x01\n" +
	"\x15ListSandboxesResponse\x12A\n" +
	"\tsandboxes\x18\x01 \x03(\v2#.openshell.compute.v1.DriverSandboxR\tsandboxes\x12&\n" +
	...
	"\x0eWatchSandboxes\x12+.openshell.compute.v1.WatchSandboxesRequest\x1a).openshell.compute.v1.WatchSandboxesEvent0\x01BRZPgitlab.com/redhat/hummingbird/experimental/factory/core/gen/openshell/compute/v1b\x06proto3"
...
var file_compute_driver_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_compute_driver_proto_goTypes = []any{
	...
	nil,                                   // 26: openshell.compute.v1.GetCapabilitiesResponse.FeaturesEntry
	nil,                                   // 27: openshell.compute.v1.DriverSandboxSpec.EnvironmentEntry
	nil,                                   // 28: openshell.compute.v1.DriverSandboxTemplate.LabelsEntry
	nil,                                   // 29: openshell.compute.v1.DriverSandboxTemplate.EnvironmentEntry
	nil,                                   // 30: openshell.compute.v1.DriverPlatformEvent.MetadataEntry
	(*structpb.Struct)(nil),               // 31: google.protobuf.Struct
	(*timestamppb.Timestamp)(nil),         // 32: google.protobuf.Timestamp
}
var file_compute_driver_proto_depIdxs = []int32{
	26, // 0: openshell.compute.v1.GetCapabilitiesResponse.features:type_name -> openshell.compute.v1.GetCapabilitiesResponse.FeaturesEntry
	3,  // 1: openshell.compute.v1.DriverSandbox.spec:type_name -> openshell.compute.v1.DriverSandboxSpec
	6,  // 2: openshell.compute.v1.DriverSandbox.status:type_name -> openshell.compute.v1.DriverSandboxStatus
	27, // 3: openshell.compute.v1.DriverSandboxSpec.environment:type_name -> openshell.compute.v1.DriverSandboxSpec.EnvironmentEntry
	4,  // 4: openshell.compute.v1.DriverSandboxSpec.template:type_name -> openshell.compute.v1.DriverSandboxTemplate
	28, // 5: openshell.compute.v1.DriverSandboxTemplate.labels:type_name -> openshell.compute.v1.DriverSandboxTemplate.LabelsEntry
	29, // 6: openshell.compute.v1.DriverSandboxTemplate.environment:type_name -> openshell.compute.v1.DriverSandboxTemplate.EnvironmentEntry
	5,  // 7: openshell.compute.v1.DriverSandboxTemplate.resources:type_name -> openshell.compute.v1.DriverResourceRequirements
	31, // 8: openshell.compute.v1.DriverSandboxTemplate.platform_config:type_name -> google.protobuf.Struct
	7,  // 9: openshell.compute.v1.DriverSandboxStatus.conditions:type_name -> openshell.compute.v1.DriverCondition
	32, // 10: openshell.compute.v1.DriverCondition.last_transition_time:type_name -> google.protobuf.Timestamp
	30, // 11: openshell.compute.v1.DriverPlatformEvent.metadata:type_name -> openshell.compute.v1.DriverPlatformEvent.MetadataEntry
	2,  // 12: openshell.compute.v1.ValidateSandboxCreateRequest.sandbox:type_name -> openshell.compute.v1.DriverSandbox
	2,  // 13: openshell.compute.v1.GetSandboxResponse.sandbox:type_name -> openshell.compute.v1.DriverSandbox
	2,  // 14: openshell.compute.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.compute.v1.DriverSandbox
	2,  // 15: openshell.compute.v1.CreateSandboxRequest.sandbox:type_name -> openshell.compute.v1.DriverSandbox
	...
	22, // 18: openshell.compute.v1.WatchSandboxesEvent.sandbox:type_name -> openshell.compute.v1.WatchSandboxesSandboxEvent
	23, // 19: openshell.compute.v1.WatchSandboxesEvent.deleted:type_name -> openshell.compute.v1.WatchSandboxesDeletedEvent
	24, // 20: openshell.compute.v1.WatchSandboxesEvent.platform_event:type_name -> openshell.compute.v1.WatchSandboxesPlatformEvent
	...
	21, // 28: openshell.compute.v1.ComputeDriver.WatchSandboxes:input_type -> openshell.compute.v1.WatchSandboxesRequest
	1,  // 29: openshell.compute.v1.ComputeDriver.GetCapabilities:output_type -> openshell.compute.v1.GetCapabilitiesResponse
	10, // 30: openshell.compute.v1.ComputeDriver.ValidateSandboxCreate:output_type -> openshell.compute.v1.ValidateSandboxCreateResponse
	12, // 31: openshell.compute.v1.ComputeDriver.GetSandbox:output_type -> openshell.compute.v1.GetSandboxResponse
	14, // 32: openshell.compute.v1.ComputeDriver.ListSandboxes:output_type -> openshell.compute.v1.ListSandboxesResponse
	16, // 33: openshell.compute.v1.ComputeDriver.CreateSandbox:output_type -> openshell.compute.v1.CreateSandboxResponse
	18, // 34: openshell.compute.v1.ComputeDriver.StopSandbox:output_type -> openshell.compute.v1.StopSandboxResponse
	20, // 35: openshell.compute.v1.ComputeDriver.DeleteSandbox:output_type -> openshell.compute.v1.DeleteSandboxResponse
	25, // 36: openshell.compute.v1.ComputeDriver.WatchSandboxes:output_type -> openshell.compute.v1.WatchSandboxesEvent
